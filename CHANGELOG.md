...
**Upgrade:** See [UPGRADE.md](UPGRADE.md#upgrading-to-v099) for instructions and cleanup steps.
...
- **Clearer warning messages** - Nested evaluator warnings now show full relative paths (e.g., `google/gemini-flash/evaluator.yml`) instead of just `evaluator.yml`.
