...
**Task**: ADV-0071 - Fix Version Management + Release 0.9.11
**Task File**: `.kit/tasks/4-in-review/ADV-0071-fix-version-management-release-0.9.11.md`
...
- Bumped version to 0.9.11 with CHANGELOG section covering ADV-0065 through ADV-0070 structural cleanup series
...
- `pyproject.toml` (modified) — version 0.9.10 -> 0.9.11
- `tests/conftest.py` (modified) — fixed `cli_python` and `run_cli` fixtures
- `CHANGELOG.md` (modified) — added [0.9.11] section
...
- **Post-merge**: Create git tag `v0.9.11` after merge.
