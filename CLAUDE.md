...
.kit/                  Builder infrastructure root
  ...
  templates/           Builder templates (agent, task-starter, operational-rules)
  adr/                 Builder-layer ADRs
...
Full listing: `.claude/agents/` -- see `.kit/templates/AGENT-TEMPLATE.md` for creating new agents.
